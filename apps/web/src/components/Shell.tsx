    ...
    <div className="shell">
      <header className="topbar">
        {/*
          ...
          the nav already carries every destination, so the mark is the way out to scriptumiq.com
          rather than a second route to Today. A plain anchor, since this is a cross-host
          navigation when the two hosts are split.
        */}
        <a href={publicUrl()} className="brand" aria-label="ScriptumIQ — go to scriptumiq.com">
          <CompassRose size={28} />
          <Wordmark size={20} />
        </a>
        {user ? <NavLinks /> : null}
      ...
      <div className="footer">
        © 2026 ScriptumIQ · NOT AFFILIATED WITH reMARKABLE AS
        <span>·</span>
