...
export const metadata: Metadata = {
  title: "Product",
  description: "What ScriptumIQ reads, what it writes back to your reMarkable, and what it never does.",
};
...
const FEATURES: { title: string; body: string }[] = [
  ...
  { title: "Your ink conventions", body: "Tell ScriptumIQ which markup means action, follow-up, priority, or schedule this: an asterisk, an underline, a highlighter stroke, circled or boxed text, an exclamation mark, a margin star, or keywords like TODO and F/U. Pick the ones you actually use." },
  ...
  { title: "The closed loop", body: "Ticks, strike-throughs, and margin notes on ScriptumIQ's own pages are read the next night. Completed tasks roll off; new margin notes roll in. No app, no keyboard, no sync button." },
  ...
  { title: "Watch folders", body: "Choose which reMarkable folders ScriptumIQ reads. By default that's all your notebooks, excluding ebooks and PDFs." },
  ...
  return (
    <MarketingShell>
      <section className="mk-wrap mk-section">
        ...
        <p className="mk-lede">reMarkable's own text conversion is manual, page-at-a-time, and produces text. ScriptumIQ is the missing layer: it reads what you wrote today and hands you tomorrow, organized, on the same device.</p>
