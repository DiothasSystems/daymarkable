        ...
        <div className="mk-wrap mk-section tight">
          <div className="mk-faq">
            ...
            <details>
              ...
              <p>A reMarkable tablet (reMarkable 2, Paper Pro, or Paper Pro Move) signed in to a reMarkable account with cloud sync turned on, and Wi-Fi at night. ScriptumIQ reads your notebooks through the reMarkable cloud, never from the device itself, so a tablet that is offline or not connected to an account has nothing for us to read. Read about <Link href="/remarkable">the tablet and where to buy one</Link>.</p>
            </details>
            <details>
              <summary>Do I need reMarkable's paid Connect subscription?</summary>
              <p>No. ScriptumIQ needs only the cloud sync that comes with a free reMarkable account. Connect adds features such as unlimited cloud storage and handwriting conversion in reMarkable's own apps; none of them is required, and ScriptumIQ does not use them.</p>
            </details>
            <details>
