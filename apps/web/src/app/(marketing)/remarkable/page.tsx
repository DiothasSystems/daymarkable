...
export const metadata: Metadata = {
  ...
  description: "What the reMarkable paper tablet is, what it does and doesn't do, which models work with ScriptumIQ, and where to buy one.",
};
...
const MODELS: { name: string; body: string }[] = [
  ...
  { name: "reMarkable 2", body: "The classic 10.3-inch grayscale tablet, thin and light, with no front light. Still sold, still supported, and the model most existing owners have. Everything ScriptumIQ does works on it." },
...
const DOES = [
  ...
  "Cloud sync. With a free reMarkable account, everything you write syncs to reMarkable's cloud and to their desktop and mobile apps. This is the link ScriptumIQ uses.",
...
const DOESNT = [
  ...
  "Turn your handwriting into a plan. reMarkable can convert a page to text on demand, one page at a time, but it produces text, not tasks, dates, or follow-ups. That gap is what ScriptumIQ fills.",
  "Work with ScriptumIQ while offline or signed out. Notebooks reach us only through reMarkable's cloud sync, so the tablet needs an account and Wi-Fi at night.",
];
  ...
  return (
    <MarketingShell>
      <section className="mk-wrap mk-section">
        ...
        <h1 className="mk-h1 sm">A tablet that only does paper. ScriptumIQ does the rest.</h1>
        <p className="mk-lede">ScriptumIQ is built for the reMarkable paper tablet. If you already own one, you have everything you need. If you don't, here is what it is, what it does, and how to get one.</p>
        <p className="meta">ScriptumIQ is an independent product and is not affiliated with, endorsed by, or supported by reMarkable AS.</p>
      </section>
      ...
      <section className="mk-wrap mk-section">
        <div className="mk-kicker">Models that work with ScriptumIQ</div>
        <h2 className="mk-h2">Any current reMarkable. Pick by size and light.</h2>
        <p className="mk-sub">All three share the same Marker, the same notebooks, and the same cloud, so ScriptumIQ treats them identically. The differences are the screen.</p>
      ...
      <section className="mk-band">
        <div className="mk-wrap mk-section tight">
          <div className="mk-kicker">What ScriptumIQ needs from it</div>
          <h2 className="mk-h2">A reMarkable account, cloud sync on, Wi-Fi at night.</h2>
          <div className="mk-steps">
            <div>
              <div className="mk-step-label">01 · AN ACCOUNT</div>
              <p>Sign the tablet in to a reMarkable account (free) at my.remarkable.com. ScriptumIQ pairs with that account using a one-time code, and never asks for your password.</p>
            </div>
            <div>
              <div className="mk-step-label">02 · CLOUD SYNC</div>
              <p>Leave sync on. Your notebooks travel to reMarkable's cloud, which is where ScriptumIQ reads the pages you changed each day. The paid Connect subscription is not required.</p>
            </div>
            <div>
      ...
      <section className="mk-wrap mk-section">
        ...
        <div className="mk-features">
          ...
          <div className="mk-feature">
            ...
            <h3>Things you don't need for ScriptumIQ</h3>
